angular.module('brushfire').controller('profileFollowingPageController', ['$scope', '$http', function($scope, $http){
...
*/
  ...
  $scope.following = $scope.frontEnd.following;
  ...
  $scope.followOrUnfollow = function() {
    ...
    if ($scope.followedByLoggedInUser) {
      ...
      .then(function success(sailsResponse){
        ...
        $scope.following = sailsResponse.data.following;
      })
